<section id="contato" class="clearfix">
    ...
    <span class="icon-email container-inline"></span>
    <div class="container-inline">
        <h3>Via email</h3>
        <span>Envio de DVDs: <a href="#">vendas@vestibulandia.com</a></span>
        <span>Institucional: <a href="#">vestibulandia@vestibulandia.com</a></span>
    </div>

    <span class="icon-user container-inline clearleft"></span>
    <div class="container-inline">
        <h3>Vestibulandia nas Redes</h3>
        <a href="#"><span class="icon-youtube">/nerckie</span></a>
        <a href="#"><span class="icon-facebook">/nerckie</span></a>
        <a href="#"><span class="icon-twitter">/nerckie</span></a>
    </div>
    
    <span class="icon-mail2 container-inline clearleft"></span>
    <div class="container-inline">
